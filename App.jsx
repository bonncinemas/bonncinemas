...
<body>
    ...
    <script type="text/babel" data-type="module">
        ...
        import { 
            ...
            ChevronLeft, Smartphone, LogOut, Film, Lock, Camera, AlertTriangle
        } from 'lucide-react';

        // --- iOS Gatekeeper Component ---
            ...
            if (!isCompatible) {
                return (
                    <div className="fixed inset-0 bg-black flex flex-col items-center justify-center p-8 text-center z-[9999]">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-4">Không hỗ trợ</h1>
                        <p className="text-slate-400 text-lg mb-8">
                            Ứng dụng này yêu cầu các tính năng bảo mật và hiệu năng cao chỉ có trên iOS 16+.
                        </p>
                        <div className="bg-slate-900 p-4 rounded-xl border border-slate-800 w-full max-w-xs">
                            <p className="text-sm text-slate-500 uppercase font-bold mb-1">Thiết bị của bạn</p>
                        ...
                        <div className="mt-8 text-red-400 text-sm font-medium flex items-center gap-2">
                            ...
                            <span>Vui lòng cập nhật iOS 16 hoặc mới hơn</span>
                        </div>
                    </div>
                );
            }
